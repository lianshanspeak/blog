 ...
 // theme: 'vdoing', // 使用npm包主题
  ...
  themeConfig: {
    ...
    nav: [
      ...
      {
        text: '数据库',
        link: '/shujuku/', //目录页链接，此处link是vdoing主题新增的配置项，有二级导航时，可以点击一级导航跳到目录页
        items: [
    ...
    // titleBadgeIcons: [ // 文章标题前图标的地址，默认主题内置图标
    //   'https://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200507175845.jpeg',
    //   'ttps://cdn.jsdelivr.net/gh/xugaoyi/image_store/blog/20200507175846.jpeg'
    // ],
  ...
  head: [
    ...
    ['meta', { name: 'referrer', content: 'no-referrer-when-downgrade' }],//解决网站统计不准的问题
